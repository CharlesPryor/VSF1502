...
//@interface Pryor_Charles_Project4Object : NSObject
//@end

@interface Pryor_Charles_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Pryor_Charles_Project4Object class]])
		{
			for (NSString *key in [[(Pryor_Charles_Project4Object*)o modules] allKeys])
			{
