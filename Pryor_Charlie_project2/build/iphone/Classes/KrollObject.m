...
//@interface Pryor_Charlie_project2Object : NSObject
//@end

@interface Pryor_Charlie_project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Pryor_Charlie_project2Object class]])
		{
			for (NSString *key in [[(Pryor_Charlie_project2Object*)o modules] allKeys])
			{
