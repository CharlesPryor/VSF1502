 ...
 * to send analytic data that can be viewed on the Pryor_Charlie_project2 Dashboard.
 *
 * For information on getting started with Pryor_Charlie_project2 Platform Services,
