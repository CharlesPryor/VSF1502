...
// in simulator we redefine to format for Pryor_Charles_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.pryor_charles_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pryor_charles_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPryor_Charles_Project3NativeItemNone = -1, 
	UIPryor_Charles_Project3NativeItemSpinner = -2,
	UIPryor_Charles_Project3NativeItemProgressBar = -3,
	
	UIPryor_Charles_Project3NativeItemSlider = -4,
	UIPryor_Charles_Project3NativeItemSwitch = -5,
	UIPryor_Charles_Project3NativeItemMultiButton = -6,
	UIPryor_Charles_Project3NativeItemSegmented = -7,
	
	UIPryor_Charles_Project3NativeItemTextView = -8,
	UIPryor_Charles_Project3NativeItemTextField = -9,
	UIPryor_Charles_Project3NativeItemSearchBar = -10,
	
	UIPryor_Charles_Project3NativeItemPicker = -11,
	UIPryor_Charles_Project3NativeItemDatePicker = -12,
	
	UIPryor_Charles_Project3NativeItemInfoLight = -13,
	UIPryor_Charles_Project3NativeItemInfoDark = -14,
	
	UIPryor_Charles_Project3NativeItemDisclosure = -15,
	
	UIPryor_Charles_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Pryor_Charles_Project3 instances of
