 ...
 * to send analytic data that can be viewed on the Pryor_Charles_Project4 Dashboard.
 *
 * For information on getting started with Pryor_Charles_Project4 Platform Services,
