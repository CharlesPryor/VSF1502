...
/**
 Base class for all Pryor_Charlie_project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Pryor_Charlie_project2 view hierarchy (such as wrapped iOS UIViews) was touched.
