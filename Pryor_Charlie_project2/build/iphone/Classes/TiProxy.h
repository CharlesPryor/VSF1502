...
//Rare exceptions to indicate a bug in the _pryor_charlie_project2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Pryor_Charlie_project2 proxies.
 */
