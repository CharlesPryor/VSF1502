...
/**
 The base class for all Pryor_Charles_Project3 modules
 */
...
/**
 Pryor_Charles_Project3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Pryor_Charles_Project3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Pryor_Charles_Project3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Pryor_Charles_Project3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Pryor_Charles_Project3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
