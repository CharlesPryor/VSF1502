...
//@interface Pryor_Charles_Project3Object : NSObject
//@end

@interface Pryor_Charles_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Pryor_Charles_Project3Object class]])
		{
			for (NSString *key in [[(Pryor_Charles_Project3Object*)o modules] allKeys])
			{
