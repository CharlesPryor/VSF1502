...
@interface Pryor_Charlie_project2Object : KrollCoverageObject {
#else
@interface Pryor_Charlie_project2Object : KrollObject {
#endif
@private
...
extern NSString * Pryor_Charlie_project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Pryor_Charlie_project2Object *_pryor_charlie_project2;
    KrollObject* console;
	BOOL shutdown;
