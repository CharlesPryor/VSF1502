...
//Rare exceptions to indicate a bug in the _pryor_charlie_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Pryor_Charlie_Project1 proxies.
 */
