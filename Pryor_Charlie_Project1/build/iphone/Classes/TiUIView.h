...
/**
 Base class for all Pryor_Charlie_Project1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Pryor_Charlie_Project1 view hierarchy (such as wrapped iOS UIViews) was touched.
