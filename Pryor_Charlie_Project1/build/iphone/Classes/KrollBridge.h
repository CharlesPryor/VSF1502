...
@interface Pryor_Charlie_Project1Object : KrollCoverageObject {
#else
@interface Pryor_Charlie_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Pryor_Charlie_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Pryor_Charlie_Project1Object *_pryor_charlie_project1;
    KrollObject* console;
	BOOL shutdown;
