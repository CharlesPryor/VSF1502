...
@interface Pryor_Charles_Project4Object : KrollCoverageObject {
#else
@interface Pryor_Charles_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Pryor_Charles_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Pryor_Charles_Project4Object *_pryor_charles_project4;
    KrollObject* console;
	BOOL shutdown;
