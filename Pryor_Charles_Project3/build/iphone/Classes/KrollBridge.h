...
@interface Pryor_Charles_Project3Object : KrollCoverageObject {
#else
@interface Pryor_Charles_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Pryor_Charles_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Pryor_Charles_Project3Object *_pryor_charles_project3;
    KrollObject* console;
	BOOL shutdown;
