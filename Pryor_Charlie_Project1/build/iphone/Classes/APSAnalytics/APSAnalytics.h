 ...
 * to send analytic data that can be viewed on the Pryor_Charlie_Project1 Dashboard.
 *
 * For information on getting started with Pryor_Charlie_Project1 Platform Services,
