...
//@interface Pryor_Charlie_Project1Object : NSObject
//@end

@interface Pryor_Charlie_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Pryor_Charlie_Project1Object class]])
		{
			for (NSString *key in [[(Pryor_Charlie_Project1Object*)o modules] allKeys])
			{
