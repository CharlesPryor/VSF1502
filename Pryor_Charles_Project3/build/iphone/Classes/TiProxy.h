...
//Rare exceptions to indicate a bug in the _pryor_charles_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Pryor_Charles_Project3 proxies.
 */
