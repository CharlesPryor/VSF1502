...
// in simulator we redefine to format for Pryor_Charlie_project2 Developer console
...
{\
	NSString * exceptionName = [@"org.pryor_charlie_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pryor_charlie_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPryor_Charlie_project2NativeItemNone = -1, 
	UIPryor_Charlie_project2NativeItemSpinner = -2,
	UIPryor_Charlie_project2NativeItemProgressBar = -3,
	
	UIPryor_Charlie_project2NativeItemSlider = -4,
	UIPryor_Charlie_project2NativeItemSwitch = -5,
	UIPryor_Charlie_project2NativeItemMultiButton = -6,
	UIPryor_Charlie_project2NativeItemSegmented = -7,
	
	UIPryor_Charlie_project2NativeItemTextView = -8,
	UIPryor_Charlie_project2NativeItemTextField = -9,
	UIPryor_Charlie_project2NativeItemSearchBar = -10,
	
	UIPryor_Charlie_project2NativeItemPicker = -11,
	UIPryor_Charlie_project2NativeItemDatePicker = -12,
	
	UIPryor_Charlie_project2NativeItemInfoLight = -13,
	UIPryor_Charlie_project2NativeItemInfoDark = -14,
	
	UIPryor_Charlie_project2NativeItemDisclosure = -15,
	
	UIPryor_Charlie_project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Pryor_Charlie_project2 instances of
