...
// in simulator we redefine to format for Pryor_Charles_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.pryor_charles_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pryor_charles_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPryor_Charles_Project4NativeItemNone = -1, 
	UIPryor_Charles_Project4NativeItemSpinner = -2,
	UIPryor_Charles_Project4NativeItemProgressBar = -3,
	
	UIPryor_Charles_Project4NativeItemSlider = -4,
	UIPryor_Charles_Project4NativeItemSwitch = -5,
	UIPryor_Charles_Project4NativeItemMultiButton = -6,
	UIPryor_Charles_Project4NativeItemSegmented = -7,
	
	UIPryor_Charles_Project4NativeItemTextView = -8,
	UIPryor_Charles_Project4NativeItemTextField = -9,
	UIPryor_Charles_Project4NativeItemSearchBar = -10,
	
	UIPryor_Charles_Project4NativeItemPicker = -11,
	UIPryor_Charles_Project4NativeItemDatePicker = -12,
	
	UIPryor_Charles_Project4NativeItemInfoLight = -13,
	UIPryor_Charles_Project4NativeItemInfoDark = -14,
	
	UIPryor_Charles_Project4NativeItemDisclosure = -15,
	
	UIPryor_Charles_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Pryor_Charles_Project4 instances of
