...
// in simulator we redefine to format for Pryor_Charlie_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.pryor_charlie_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pryor_charlie_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPryor_Charlie_Project1NativeItemNone = -1, 
	UIPryor_Charlie_Project1NativeItemSpinner = -2,
	UIPryor_Charlie_Project1NativeItemProgressBar = -3,
	
	UIPryor_Charlie_Project1NativeItemSlider = -4,
	UIPryor_Charlie_Project1NativeItemSwitch = -5,
	UIPryor_Charlie_Project1NativeItemMultiButton = -6,
	UIPryor_Charlie_Project1NativeItemSegmented = -7,
	
	UIPryor_Charlie_Project1NativeItemTextView = -8,
	UIPryor_Charlie_Project1NativeItemTextField = -9,
	UIPryor_Charlie_Project1NativeItemSearchBar = -10,
	
	UIPryor_Charlie_Project1NativeItemPicker = -11,
	UIPryor_Charlie_Project1NativeItemDatePicker = -12,
	
	UIPryor_Charlie_Project1NativeItemInfoLight = -13,
	UIPryor_Charlie_Project1NativeItemInfoDark = -14,
	
	UIPryor_Charlie_Project1NativeItemDisclosure = -15,
	
	UIPryor_Charlie_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Pryor_Charlie_Project1 instances of
